...
var (
	...
	// ErrNoBaseline is returned when a recheck references a baseline id that the
	// store does not hold (expired, wrong id, or never captured).
	ErrNoBaseline = errors.New("no baseline for id")
)
